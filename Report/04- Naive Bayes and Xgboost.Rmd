...
Rather than looking at all of these manually, which would take a long time and involve difficult comparisons, I will use the train function to consider the tuning of the parameters and output the best models. I plot the best models so that we can see the parameters which maximise the accuracy.
...
I also use label encoding for the categorical variables rather than one-hot, following reading their comparison in reference 1.
...
## References
1. One hot vs label encoding: https://www.ijeat.org/wp-content/uploads/papers/v11i2/B32381211221.pdf

2. Ideas for classification of KDD cup data: https://medium.com/analytics-vidhya/building-an-intrusion-detection-model-using-kdd-cup99-dataset-fb4cba4189ed

3. Naive Bayes and how to use gridsearch: https://uc-r.github.io/naive_bayes

4. XGBoost for multi-class problems : https://rpubs.com/mharris/multiclass_xgboost
...
We get an accuracy of 100%, even on the left out data and even for the small classes! Hence this is the model I will use for performance evaluation on the testing data. It will be interesting to see how it reacts to the unseen attack types in the labelled test data.
